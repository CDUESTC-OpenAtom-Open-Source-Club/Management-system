...
export function getUsers(params: { keyword?: string; cohortId?: number; page?: number; size?: number }): Promise<PageResult<UserAccountResponse>> { return request.get('/api/users', { params }) }
